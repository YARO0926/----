...
def clickNext():
    ...
    if num > 8:
        num = 0
    photo = PhotoImage(file = "C:\\Users\\cjwon\\OneDrive\\바탕 화면\\대학교 파일\\엔트리 팀플 자료\\책뭉이.webp" + fnameList[num])
...
photo = PhotoImage(file= "C:\\Users\\cjwon\\OneDrive\\바탕 화면\\대학교 파일\\엔트리 팀플 자료\\책뭉이.webp" + fnameList[0])
